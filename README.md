...
| <a name="input_cluster_addon_timeouts"></a> [cluster\_addon\_timeouts](#input\_cluster\_addon\_timeouts) | Create, update, and delete timeout configurations for the cluster addons | `map(string)` | `{}` | no |
